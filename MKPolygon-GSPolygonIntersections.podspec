#
#  Be sure to run `pod spec lint MKPolygon-GSPolygonIntersections.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/ivulyov90/MKPolygon-GSPolygonIntersections"
  ...
  s.license      = "Check https://github.com/ivulyov90/MKPolygon-GSPolygonIntersections/blob/master/LICENSE"
  ...
  s.author             = { "Chad Saxon" => "https://github.com/geeksweep/MKPolygon-GSPolygonIntersections" }
  ...
  s.source_files  = "GSPolygonIntersections", "GSPolygonIntersections/**/*.{h,m}"
